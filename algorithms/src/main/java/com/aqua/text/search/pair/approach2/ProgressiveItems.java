package com.aqua.text.search.pair.approach2;
...
class ProgressiveItems {
	...
	void updateSuccessfullyMatchedAndPurgeFinishedOrInvalidItems(char currentCharacter, List<KeywordOccurance> successfullyMatched) {
	...
	private Set<KeywordOccurance> createDroppedItemsList(char currentCharacter, List<KeywordOccurance> successfullyMatched) {
