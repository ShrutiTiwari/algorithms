...
class ReloadablePanelContainer  {
	...
	public final Map.Entry<String, JPanel> newPanelWith(Object obj) {
		if (obj instanceof QuizLevel) {
			...
			quizDropdown.addActionListener(new PaneReloadDropdownActionListener(uiTabbedPane,this));
			...
			thaatDropdown.addActionListener(new PaneReloadDropdownActionListener(uiTabbedPane,this));				
